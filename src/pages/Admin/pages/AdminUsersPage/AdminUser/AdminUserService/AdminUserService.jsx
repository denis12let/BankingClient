...
import styles from './AdminUserService.module.css';
...
const AdminUserService = ({ serviceData, isLoading, approve, ...props }) => {
  return (
    <Card>
      <div className={styles.service}>
        ...
        <div className={styles.payment}>
          {serviceData.type === SERVICE_TYPE.LOAN && (
            <div className={styles.approve}>
              <CustomButton onClick={() => approve(true, serviceData.id)}>Одобрить</CustomButton>
              <CustomButton onClick={() => approve(false, serviceData.id)}>Отказать</CustomButton>
            </div>
          )}
        </div>
      </div>
